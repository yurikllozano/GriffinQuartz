...
<head>
    ...
    <title>Cambria Torquay Quartz Countertops | Griffin Quartz</title>
    <meta name="description" content="Cambria Torquay quartz - classic Calacatta marble alternative with soft gray veining on white. South Florida installation. FREE estimates.">
...
<?php $basePath = '..'; include '../includes/header.php'; ?>
    ...
    <section class="product-hero">
        <div class="hero-background">
            <img src="../images/cambria-torquay-kitchen.webp" alt="Cambria Torquay quartz countertop" loading="eager" width="800" height="533">
        ...
        <div class="product-hero-container">
            ...
            <div class="product-swatch-showcase" style="position:relative">
                <div class="main-swatch"><img src="../images/cambria-products/torquay.webp" alt="Cambria Torquay sample" width="724" height="500" loading="lazy"></div>
    ...
    <section class="faq-section" style="padding:5rem 0;background:#fff">
        <div class="container">
            <div style="text-align:center;margin-bottom:3rem">
                <h2 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:2.25rem;font-weight:500;color:var(--color-primary)">Torquay FAQs</h2>
            </div>
