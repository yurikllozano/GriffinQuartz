...
<head>
    ...
    <title>Cambria Ironsbridge Quartz Countertops | Griffin Quartz</title>
    <meta name="description" content="Cambria Ironsbridge quartz - warm honey and cool gray blend. The most versatile neutral. South Florida installation. FREE estimates. Call (720) 324-1436.">
    ...
    <section class="product-gallery" style="padding:5rem 0;background:var(--color-light)">
        <div class="container">
            <div style="text-align:center;margin-bottom:3rem">
                <h2 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:clamp(2rem,4vw,2.5rem);font-weight:500;color:var(--color-primary);margin-bottom:.5rem">Ironsbridge in Beautiful Spaces</h2>
