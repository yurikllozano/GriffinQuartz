            ...
            <ul class="nav-list">
                <li class="nav-item dropdown has-mega-menu">
                    ...
                    <div class="mega-menu mega-menu-icons">
                        <div class="mega-menu-grid">
                            <div class="mega-menu-section">
                                <div class="mega-menu-section-title">By Room</div>
                                <div class="mega-menu-section-items">
                            ...
                            <div class="mega-menu-section">
                                <div class="mega-menu-section-title">By Material</div>
                                <div class="mega-menu-section-items">
                            ...
                            <div class="mega-menu-section">
                                <div class="mega-menu-section-title">Explore</div>
                                <div class="mega-menu-section-items">
                    ...
                    <ul class="dropdown-menu mobile-dropdown">
                        <li class="mobile-dropdown-header">By Room</li>
                        <li><a href="<?php echo $prefix; ?>kitchen-bath">Kitchen Countertops</a></li>
                        <li><a href="<?php echo $prefix; ?>kitchen-bath#bathroom">Bathroom Vanities</a></li>
                        <li><a href="<?php echo $prefix; ?>commercial">Commercial Projects</a></li>
                        <li class="mobile-dropdown-header">By Material</li>
                        ...
                        <li><a href="<?php echo $prefix; ?>semi-precious-stone-countertops">Semi-Precious Stone Countertops</a></li>
                        <li class="mobile-dropdown-header">Explore</li>
                        ...
                        <li><a href="<?php echo $prefix; ?>our-services">All Services</a></li>
